...
Clarinet.test({
  ...
  async fn(chain: Chain, accounts: Map<string, Account>) {
    ...
    console.log(chain.callReadOnlyFn('clarity-bitcoin', 'get-bc-h-hash', [types.uint(794680)], deployer.address));
    ...
    // console.log(chain.callReadOnlyFn('clarity-bitcoin', 'was-tx-mined-compact', [
    //   types.uint(109655),
    //   inscription_data,
    //   "0x0040002094c612a35b16f031dc589dccef93a671e763e00efc6c02000000000000000000f42688ac3b24036b38263f73f1ba1ae5924057fe8a6390b25e8b367f2fe0f53bf3f68c646d6005179da8a102",
